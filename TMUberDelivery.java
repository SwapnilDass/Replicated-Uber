...
public class TMUberDelivery extends TMUberService
{
  ...
  public boolean equals(Object other)
  {
    ...
    if (!(other instanceof TMUberDelivery)){ //Checks if other is a Delivery type or not
      return false;
    }
    TMUberDelivery otherdelivery = (TMUberDelivery) other; //Casting other variable to type TMUberDelivery
    // If this and other are deliveries, check to see if they are equal
    return ((this.restaurant.equals(otherdelivery.getRestaurant()) && (this.foodOrderId.equals(otherdelivery.getFoodOrderId()) && super.equals(otherdelivery))));
  }
  /*
