...
public class User 
{
  ...
  {
    User otherUser = (User) other;  //Variable other is casted to the type User
    if ((this.name.equals(otherUser.getName())) && this.address.equals(otherUser.getAddress())){ //Checks if this name and address is equal to the other name and address of other user.
      return true;
    }
    return false;
  }
